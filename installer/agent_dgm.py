...
def build_system_instruction() -> str:
    return (
        "You are a specialized AI assistant perfectly configured for parsing **DG_M (MaxGauge Master)** installation commands.\n"
        "Your mission is to extract the fields required ONLY for a DG_M installation from the user's natural language input. "
        ...
        "If you encounter ANY variables specifically related to DG_M configs, add them directly to extra_vars_list formatted EXACTLY as 'KEY=VALUE'."
    )
